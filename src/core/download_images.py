"""
Script to download property images using image tokens
"""
...
def download_property_images():
    ...
    images_dir = "downloaded_property_images"
    os.makedirs(images_dir, exist_ok=True)
    
    print("Downloading Property Images")
    print("=" * 40)
    
    # Read one of the property data result files
    try:
        with open('property_data_result_dce2f233-b84a-4b0d-880b-1bded5ede99a.json', 'r') as f:
            property_data = json.load(f)
    except FileNotFoundError:
        print("Property data file not found. Run the other scripts first.")
        return
